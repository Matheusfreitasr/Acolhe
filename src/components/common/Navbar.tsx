...
const NavLink = styled(Nav.Link)`
  ...
  &:hover, &.active {
    color: ${props => props.theme.colors.progressWhite} !important;
    &::after {
      width: 100%;
    }
  }
...
const LoginButton = styled(Button)`
  ...
  &:hover {
    background-color: ${props => props.theme.colors.progressLightBlue};
    color: ${props => props.theme.colors.progressBlack};
